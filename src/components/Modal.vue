  ...
  <transition name="modal">
    <div class="modal-mask">
      ...
      {{ quizScore.allQuestions }}
            ...
            <div id="chooseCategory"> Wanna choose another category?
              <a
          ...
          <div class="modal-footer">
            <button id="play-again" class="button-footer" @click="$emit('reload')"> Play Again </button>
            <button id="close-button" class="button-footer" @click="$emit('close')"> Close </button>
          </div>
        </div>
      </div>
    </div>
