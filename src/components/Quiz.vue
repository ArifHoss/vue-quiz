<template>
  <div id="quiz-container">
    <img id="logo-crown" src="@/assets/family.png" alt="headsUP Crown" />
    <h1 id="logo-headline">SuperQuizer</h1>
...
export default {
  ...
  data(){
    return {
      questions: [], /*question data is set to an empty array by default*/
      loading: true, /*loading is set to true, because we will be fetching questions from the Trivia API and push them to the questions array when the component is mounted. On each call, we are fetching 10 questions at once*/
      index: 0
    };
  },
